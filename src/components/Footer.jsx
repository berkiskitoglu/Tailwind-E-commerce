export default function Footer() {
  return (
    <footer className="bg-gray-50">
      <div className="mx-auto max-w-[75%] p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">Kaynaklar</h2>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">Bizi Takip Edin</h2>
              <ul className="text-gray-500 font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:underline">
                    Facebook
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">Hukuki</h2>
              <ul className="text-gray-500 font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:underline">
                    Gizlilik Politikası
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            © 2025 <a href="#">E-Ticaret</a>. Tüm hakları saklıdır.
          </span>
